#Uso de um sistema especialista para detecção de Asma
#Será seguido algumas etapas, elas sao:
# Instalar o pacote Sets -> Carregar o Pacote Sets -> Criar o Universo -> Criar as variáveis -> Criar as Regras ->
# -> Criar modelo de inferência -> Fazer a Inferência -> Desfuzzificar -> "limpar" o universo
...
#criacao de variaveis com a função set para atribuir objeto as variaveis
variaveis <- set(
  # Variável frequencia com a função fuzzy_partition com um vetor com os valores para cada variável
...
#definicao das regras para análise
regras <-
  set(
